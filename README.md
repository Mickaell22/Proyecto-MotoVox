...
Intercomunicador para moto en tiempo real. Conecta conductor y copiloto por audio P2P sobre WiFi local mediante WebRTC, con reducción de ruido RNNoise compilado en C nativo para ARM64.
...
- **Audio P2P en tiempo real** — WebRTC sobre WiFi local
